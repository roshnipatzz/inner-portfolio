...
class IPWidget extends WP_Widget{
	...
	public function widget($args, $instance){
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? 'Inner Voice Blog' : $instance['title'], $instance, $this->id_base); //apply_filter protects the code from bad codes
